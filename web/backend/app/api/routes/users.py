...
def register_user(_: dict[str, Any] = Body(default_factory=dict)) -> Any:
    """
    Open public signup is disabled. Use /auth/signup with an invite token.
    """
    raise HTTPException(status_code=404, detail="Signup requires an invite")
