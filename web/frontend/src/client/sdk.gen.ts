...
export class AdminService {
     ...
     * @param data The data for the request.
     * @param data.formData
     * @returns FactDecompImportSummary Successful Response
     * @throws ApiError
     */
    public static ingestDataset(data: AdminIngestDatasetData): CancelablePromise<AdminIngestDatasetResponse> {
        return __request(OpenAPI, {
            method: 'POST',
    ...
    public static readAgreementMetrics(data: AdminReadAgreementMetricsData = {}): CancelablePromise<AdminReadAgreementMetricsResponse> {
        return __request(OpenAPI, {
            ...
            query: {
                ...
                max_judgments: data.maxJudgments
            },
            errors: {
                422: 'Validation Error'
            }
     ...
     * @param data The data for the request.
     * @param data.leftUserId
     * @param data.rightUserId
     * @param data.datasetId
    ...
    public static readInterUserAgreement(data: AdminReadInterUserAgreementData): CancelablePromise<AdminReadInterUserAgreementResponse> {
        return __request(OpenAPI, {
            ...
            query: {
                left_user_id: data.leftUserId,
                right_user_id: data.rightUserId,
                dataset_id: data.datasetId,
...
export class CreateService {
    ...
    /**
     * Preview Fact Decomp Creation
     * @param data The data for the request.
     * @param data.requestBody
     * @returns ValidationPreview Successful Response
     * @throws ApiError
     */
    public static previewFactDecompCreation(data: CreatePreviewFactDecompCreationData): CancelablePromise<CreatePreviewFactDecompCreationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/create/fact-decomp/preview',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
    ...
    /**
     * Read Fact Decomp Save Receipt
     * @param data The data for the request.
     * @param data.requestId
     * @returns FactDecompSaveReceiptResponse Successful Response
     * @throws ApiError
     */
    public static readFactDecompSaveReceipt(data: CreateReadFactDecompSaveReceiptData): CancelablePromise<CreateReadFactDecompSaveReceiptResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/create/fact-decomp/receipts/{request_id}',
            path: {
     ...
     * @param data The data for the request.
     * @param data.itemId
     * @returns AuthoringItemState Successful Response
     * @throws ApiError
     */
    public static readAuthoringItem(data: CreateReadAuthoringItemData): CancelablePromise<CreateReadAuthoringItemResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/create/items/{item_id}',
            path: {
                item_id: data.itemId
            },
            errors: {
    ...
    /**
     * Submit Retrieval Batch
     * @param data The data for the request.
     * @param data.requestBody
     * @returns RetrievalSubmissionBatchResponse Successful Response
     * @throws ApiError
     */
    public static submitRetrievalBatch(data: CreateSubmitRetrievalBatchData): CancelablePromise<CreateSubmitRetrievalBatchResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/create/retrieval/batch',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                409: 'Conflict',
    ...
    /**
     * Read Retrieval Batch
     * @param data The data for the request.
     * @param data.requestId
     * @returns RetrievalSubmissionBatchResponse Successful Response
     * @throws ApiError
     */
    public static readRetrievalBatch(data: CreateReadRetrievalBatchData): CancelablePromise<CreateReadRetrievalBatchResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/create/retrieval/batches/{request_id}',
            path: {
                request_id: data.requestId
            },
            errors: {
    ...
    /**
     * Preview Retrieval Creation
     * @param data The data for the request.
     * @param data.requestBody
     * @returns ValidationPreview Successful Response
     * @throws ApiError
     */
    public static previewRetrievalCreation(data: CreatePreviewRetrievalCreationData): CancelablePromise<CreatePreviewRetrievalCreationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/create/retrieval/preview',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
...
export class ReviewService {
     ...
     * @throws ApiError
     */
    public static submitModelEvalReview(data: ReviewSubmitModelEvalReviewData): CancelablePromise<ReviewSubmitModelEvalReviewResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/review/fact-decomp/{task_id}/model-eval',
            path: {
                task_id: data.taskId
            },
            body: data.requestBody,
